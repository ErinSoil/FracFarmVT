...
mgPOM_tmeanppt_b <- data %>% 
  ...
  theme(
    ...
    axis.line = element_line(color = "black")  # Add black axis lines (only this part changes)
  ) 
...
ggsave("Figure6_v16.jpeg", plot = Figure6_v16, width = 20, height = 12, units = "cm", dpi = 300)
...
ggsave("Figure3_18.jpeg", plot = Figure3_18, width = 20, height = 13, units = "cm", dpi = 300)
